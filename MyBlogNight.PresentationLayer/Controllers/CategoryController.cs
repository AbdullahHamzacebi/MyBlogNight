...
namespace MyBlogNight.PresentationLayer.Controllers
{
    public class CategoryController : Controller
    {
        ...
        public IActionResult CreateCategory(Category category)
        {
            ...
            //savechange eklememe sebebimiz generic kısmında yapmıştık zaten her bir metod için.
            //savechanges gelmez. context'e bağlı sınıfa ihtiyaç lazım onun için de gelmez.
        }
